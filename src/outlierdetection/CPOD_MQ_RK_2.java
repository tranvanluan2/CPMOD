...
//                HashMap<C_Data, Double> cached_distance = new HashMap<>();
        ...
        for (Integer sIdx : all_slides.keySet()) {
            for (C_Data d : all_slides.get(sIdx)) {
                for (OD_Query q : all_queries) {
                    ...
                    if (d.pred_neighbor_count.containsKey(q) && d.pred_neighbor_count.get(q).containsKey(expiredSlideIndex)) {
